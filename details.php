	...
	<div class="back1" align="center">	
			<form method="POST" >
					...
					<div class="data" name="data">
						...
						<table class="table" >
							<tr><td>
								<input type="submit" formaction="adstddetails.php" value="Personal Details" class="but">
							</td></tr>
							<tr><td>
								<input type="submit" formaction="perdetails.php" value="Academic Details" class="but">
							</td></tr>				 
						</div>
					</div>
