	...
	<div class="back" align="center">	
		...
		$h=1;
						...
						foreach($res as $d)
						{
							...
							echo "<td><input type='radio' name=a['$h'] value='yes' selected>yes<input type='radio' name=a['$h'] value='no' checked='checked'>no</td>";
							$h=$h+1;
					...
					<tr><td>
								<input type="submit" formaction="sel.php" value="Select Students" class="but">
							</td></tr>
