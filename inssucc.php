...
<div class="back1" align="center">	
			<form method="POST" >
					...
					<ul>
						...
						<li class=mli1><input type="submit" formaction="adstddetails.php" value="Student Details" class="btn"></li>
					...
					<ul>
						...
						<li class=mli2><input type="submit" formaction="addcmp.php" value="Recuiter Details" class="btn1"></li></li>
					</ul>
</div>					<div class="data" name="data">
						<h4>Details inserted Succesfully</h4>
					</div>
