	...
	<div class="back" align="center">	
					...
					<div class="hor">
						<ul>
							...
							<li class=mli1><input type="submit" formaction="" value="View Informaation" class="btn"></li>
						...
						<li class=mli2><input type="submit" formaction="" value="Recuiter Form" class="btn1"></li>		
						</ul>
					</div>
						<div class="data" name="data">
						<div class="d1">
							<h3>Application succcessfully placed<h3>
					</div>
					</div>
		</form>
	</div>
